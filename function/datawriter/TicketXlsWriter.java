...
import com.tixqik.object.UserBuilder;
		...
		public class TicketXlsWriter {
			protected File file;  
		    protected OutputStream os;  
		    protected Workbook book = null;  
		    public TicketXlsWriter() {  
		        super();  
		}
		    public TicketXlsWriter(File file) throws IOException, IllegalFormatException {
		        ...
		        Sheet sheet1 = book.createSheet("Tickets");
