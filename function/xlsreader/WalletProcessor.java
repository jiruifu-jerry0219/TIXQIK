...
public class WalletProcessor implements RowProcessor
{
	...
	private static WalletProcessor thisProcessor;
	
	private WalletProcessor()
	{
	...
	public static RowProcessor getInstance()
	{
		...
		{
			thisProcessor = new WalletProcessor();
		}
