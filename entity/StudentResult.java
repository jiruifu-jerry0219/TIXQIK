...
import com.tixqik.behavior.StudentPurchaseResult;
...
*/
public class StudentResult extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				StudentResult inst = new StudentResult(frame);
				inst.setVisible(true);
			}
		});
	}
public StudentResult(Vector items, Vector names) {
	...
	public StudentResult(JFrame frame) {
		super(frame);
				...
				}
				{
					...
					DeleteButton.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							...
							StudentPurchaseResult pr = new StudentPurchaseResult(itemContainer1, itemNameContainer1);
							pr.show();
							dispose();
				...
				}
				{
					...
					backbtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							...
							itemNameContainer1.clear();
							itemContainer1.clear();
							MainStudent chp = new MainStudent (itemContainer1, itemNameContainer1);
							chp.show();
