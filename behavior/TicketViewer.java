...
*/
public class TicketViewer extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				TicketViewer inst = new TicketViewer(frame);
				inst.setVisible(true);
			}
		});
	}
public TicketViewer(Vector items, Vector names) {
	...
	public TicketViewer(JFrame frame) {
		super(frame);
		initGUI();
	}
