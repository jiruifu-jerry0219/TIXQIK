...
*/
public class SellAction extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				SellAction inst = new SellAction(frame);
				inst.setVisible(true);
			}
		});
	}
public SellAction(Vector items, Vector names) {
	...
	public SellAction(JFrame frame) {
		super(frame);
		initGUI();
	}
						...
						public void actionPerformed(ActionEvent evt) {
							...
							try {
					            ...
					            Object[][]bookData = {{eventEntry.getText(),jTextField1.getText(),
					            	...
					            	jTextField4.getText(), jTextField2.getText(),jTextField5.getText()}};
							...
							JOptionPane.showMessageDialog(null, "Post for Sell Successfully!");
							int indx = viewerList.getSelectedIndex();
							itemContainer1.remove(indx);
							itemNameContainer1.remove(indx);
							eventEntry.setText(null);
							jTextField1.setText(null);
							jTextField2.setText(null);
							jTextField3.setText(null);
