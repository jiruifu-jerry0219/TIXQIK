...
*/
public class GameViewer extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				GameViewer inst = new GameViewer(frame);
				inst.setVisible(true);
			}
		});
	}
public GameViewer(Vector items, Vector names) {
	...
	public GameViewer(JFrame frame) {
		super(frame);
		initGUI();
	}
				...
				}
				{
					...
					backbtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							...
							GameHomepage chp = new GameHomepage (itemContainer, itemNameContainer);
							chp.show();
							dispose();
						}
					});
