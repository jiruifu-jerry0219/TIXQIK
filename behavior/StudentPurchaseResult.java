...
*/
public class StudentPurchaseResult extends javax.swing.JDialog {
...
public StudentPurchaseResult(Vector items, Vector names) {
	...
	public StudentPurchaseResult(JFrame frame) {
		super(frame);
		initGUI();
	}
		...
		try {
			{
				...
				}
				{
					...
					firmBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							...
							MainStudent ms = new MainStudent(itemContainer1, itemNameContainer1);
							ms.show();
							dispose();
						}
					});
				...
				}
				{
					...
					totalLabel.setText("Total Price with Discount(10% off):");
					totalLabel.setBounds(29, 536, 388, 39);
